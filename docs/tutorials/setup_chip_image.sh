...
Tutorial for Using SMQTK-IQR with GEOWATCH Data
===============================
...
This walks through the entire process of performing IQR with RGB toydata
generated by the GEOWATCH package
